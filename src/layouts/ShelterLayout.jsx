    ...
    <div style={styles.shell}>
      <style>{`
        @media (max-width: 768px) {
          .shelter-mobile-bar { display: flex !important; }
          .shelter-sidebar {
          ...
          .shelter-sidebar.open { left: 0; }
          .shelter-content { padding-top: 64px; }
        }
      `}</style>

      <div className="shelter-mobile-bar" style={styles.mobileBar}>
        <span style={styles.mobileBrand}>🏡 Shelter Portal</span>
        <button
      ...
      <aside
        className={`shelter-sidebar${sidebarOpen ? " open" : ""}`}
        style={styles.sidebar}
      >
        <div style={styles.brand}>
          <span style={styles.brandIcon}>🏡</span>
          <span style={styles.brandText}>Shelter Portal</span>
        </div>
